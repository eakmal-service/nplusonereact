    ...
    return (
        <div className="min-h-screen bg-black text-white pt-24 pb-12">
            <div className="container mx-auto px-4 max-w-4xl">
                <h1 className="text-3xl font-bold mb-8 text-silver">Notifications</h1>
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-xl p-12 flex flex-col items-center text-center">
                    ...
                    <p className="text-gray-400 mb-8 max-w-md">
                        No new notifications at the moment. We'll let you know when there are updates about your orders or exclusive offers.
                    </p>
                </div>
