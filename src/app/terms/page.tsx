        ...
        <div className="bg-black min-h-screen py-12 px-4 sm:px-6 lg:px-8 mt-28">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-8 text-gray-300">
                    ...
                    <p className="text-gray-400">
                        This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name [https://nplusonefashion.com/, including the related mobile site and mobile application (hereinafter referred to as "Platform").
                    </p>
                    <p className="text-gray-400">
                        The Platform is owned by NPlusOne Fashion , a company incorporated under the Companies Act, 1956 with its registered office at First Floor, Plot No. 17, Hariichcha Ind Co-Op Hou Soc Ltd, Opp Patco Ceramic Road No. 24, Udhana Magdalla Road, SURAT, GUJARAT, IN, 394210 (hereinafter referred to as "Platform Owner", "we", "us", "our").
                    </p>
                    <p className="text-gray-400">
                    ...
                    <strong className="block mt-4 text-silver">
                    ...
                    <section className="bg-gray-900 p-6 rounded-lg border border-gray-800">
                        <h2 className="text-xl font-bold text-silver mb-3">Use of Services</h2>
                    ...
                    <section className="bg-gray-900 p-6 rounded-lg border border-gray-800">
                        <h2 className="text-xl font-bold text-silver mb-3">Indemnity & Liability</h2>
                        <p>
                    ...
                    <section className="bg-gray-900 p-6 rounded-lg border border-gray-800">
                        <h2 className="text-xl font-bold text-silver mb-3">Governing Law & Jurisdiction</h2>
                        <ul className="list-disc pl-5 space-y-2">
                            ...
                            <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Surat and Gujarat.</li>
                        </ul>
                    </section>

                    <section className="bg-gray-900 p-6 rounded-lg border border-gray-800">
                        <h2 className="text-xl font-bold text-silver mb-3">Contact Information</h2>
                        <p>
