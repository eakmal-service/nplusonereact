...
export default function GirlsWearPage() {
  return (
    <div className="min-h-screen bg-custom-black text-white flex items-center justify-center">
      <div className="max-w-4xl w-full px-4 py-12">
        <h1 className="text-3xl font-bold mb-6">Girls Wear Collection</h1>
        <p className="mb-8">Our girls wear collection is coming soon.</p>
