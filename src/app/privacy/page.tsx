        ...
        <div className="bg-black min-h-screen">
            <div className="container mx-auto px-4 py-12 max-w-4xl text-gray-300">
                ...
                <div className="space-y-8">
                    ...
                    {/* Sharing */}
                    <section>
                        <h2 className="text-xl font-bold mb-3 uppercase tracking-wide text-silver">Sharing</h2>
                        <p className="text-gray-400">
                    ...
                    <section>
                        <h2 className="text-xl font-bold mb-3 uppercase tracking-wide text-silver">Security Precautions</h2>
                        <p className="text-gray-400">
                    ...
                    <section>
                        <h2 className="text-xl font-bold mb-3 uppercase tracking-wide text-silver">Data Deletion and Retention</h2>
                        <p className="text-gray-400">
                    ...
                    {/* Your Rights */}
                    <section>
                        <h2 className="text-xl font-bold mb-3 uppercase tracking-wide text-silver">Your Rights</h2>
                        <p className="text-gray-400">
                    ...
                    {/* Consent */}
                    <section>
                        <h2 className="text-xl font-bold mb-3 uppercase tracking-wide text-silver">Consent</h2>
                        <p className="text-gray-400">
                    ...
                    <section>
                        <h2 className="text-xl font-bold mb-3 uppercase tracking-wide text-silver">Changes to this Privacy Policy</h2>
                        <p className="text-gray-400">
